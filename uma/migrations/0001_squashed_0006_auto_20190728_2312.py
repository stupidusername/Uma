# Generated by Django 2.2.3 on 2019-07-28 23:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='uma.RoomCategory')),
                ('deleted', models.DateTimeField(editable=False, null=True)),
                ('mode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='uma.RoomMode')),
            ],
        ),
        migrations.CreateModel(
            name='CategoryStay',
